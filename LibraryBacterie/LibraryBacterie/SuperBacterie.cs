...
namespace LibraryBacterie
{
    class SuperBacterie : Bacterie
    {
        ...
        public sealed SuperBacterie(int positionX, int positionY)
        {
        ...
        public override void Manger(List<Bacterie> lesBacteriesVoisines)
        {
            ...
            {
                if (this.GetType() != lesBacteriesVoisines[compteur].GetType())
                {

                    if (this.Majorite && !lesBacteriesVoisines[compteur].Majorite)
                    {
                        //lesBacteriesVoisines[compteur].EstMort = true;
                        this.PointExp += 1;
        ...
        public bool PouvoirSeDeplacer(int positionX, int positionY)
        {
            bool peutSeDeplacer = false;
